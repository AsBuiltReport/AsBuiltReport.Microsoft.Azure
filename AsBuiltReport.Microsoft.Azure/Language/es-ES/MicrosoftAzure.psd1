...
InvokeAsBuiltReportMicrosoftAzure = ConvertFrom-StringData @'
    ...
    AzureApiError = Error en la llamada a la API de Azure: {0}
...
# Directivas de replicación de Azure Site Recovery (Get-AbrAzAsrPolicy)
GetAbrAzAsrPolicy = ConvertFrom-StringData @'
    InfoLevel = Nivel de información de AsrPolicy establecido en {0}.
    Collecting = Recopilando información de directivas de Azure Site Recovery para '{0}'.
    SectionInfo = Las directivas de replicación de Azure Site Recovery definen los objetivos de punto de recuperación (RPO) y el historial de puntos de recuperación para las máquinas virtuales replicadas.
    Heading = Directivas de replicación
    TableHeadings = Directivas de replicación
    ParagraphSummary = La siguiente tabla resume las directivas de replicación de Azure Site Recovery configuradas para el almacén de Recovery Services {0}.
    ParagraphDetail = Las siguientes secciones detallan las directivas de replicación de Azure Site Recovery configuradas para el almacén de Recovery Services {0}.
    Name = Nombre
    Provider = Proveedor
    RpoThreshold = Umbral de RPO (mins)
    RecoveryPointHistory = Historial de puntos de recuperación (hrs)
    AppConsistentFrequency = Instantánea coherente con la aplicación (mins)
    CrashConsistentFrequency = Instantánea coherente con el bloqueo (mins)
    MultiVmSync = Sincronización de varias VM
    NotApplicable = N/D
'@

# Planes de recuperación de Azure Site Recovery (Get-AbrAzAsrRecoveryPlan)
GetAbrAzAsrRecoveryPlan = ConvertFrom-StringData @'
    InfoLevel = Nivel de información de AsrRecoveryPlan establecido en {0}.
    Collecting = Recopilando información del plan de recuperación de Azure Site Recovery para '{0}'.
    SectionInfo = Los planes de recuperación de Azure Site Recovery coordinan la conmutación por error y la recuperación de grupos de máquinas virtuales, permitiendo operaciones de DR coordinadas.
    Heading = Planes de recuperación
    TableHeadings = Planes de recuperación
    ParagraphSummary = La siguiente tabla resume los planes de recuperación de Azure Site Recovery configurados para el almacén de Recovery Services {0}.
    ParagraphDetail = Las siguientes secciones detallan los planes de recuperación de Azure Site Recovery configurados para el almacén de Recovery Services {0}.
    Name = Nombre
    PrimaryFabric = Ubicación principal
    RecoveryFabric = Ubicación de recuperación
    GroupCount = Grupos
    ProtectedItemCount = Elementos protegidos
    FailoverDeploymentModel = Modelo de implementación de conmutación por error
    None = Ninguno
'@
...
GetAbrAzRecoveryServicesVault = ConvertFrom-StringData @'
    ...
    StorageRedundancy = Redundancia de almacenamiento
    CrossRegionRestore = Restauración entre regiones
    SoftDeleteState = Estado de eliminación temporal
    SoftDeleteRetentionDays = Retención de eliminación temporal (días)
    ImmutabilityState = Estado de inmutabilidad
    PublicNetworkAccess = Acceso a la red pública
    Locks = Bloqueos
    Tags = Etiquetas
    None = Ninguno
'@
