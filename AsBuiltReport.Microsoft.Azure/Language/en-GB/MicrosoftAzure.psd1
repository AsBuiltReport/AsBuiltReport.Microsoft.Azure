...
InvokeAsBuiltReportMicrosoftAzure = ConvertFrom-StringData @'
    ...
    AzureApiError = Azure API call failed: {0}
...
GetAbrAsrProtectedItems = ConvertFrom-StringData @'
    ...
    NoTestFailover = No test failover has been performed
    ParagraphDetail = The following sections detail the configuration of the Azure Site Recovery protected items within the {0} subscription.
    ReplicationProvider = Replication Provider
    Rpo = RPO (mins)
    LastRpoCalculated = Last RPO Calculated
    LastHeartbeat = Last Heartbeat
    RecoveryVmSize = Recovery VM Size
    RecoveryAvailabilityZone = Recovery Availability Zone
    NotAvailable = N/A
    None = None
'@
...
GetAbrAzRecoveryServicesVault = ConvertFrom-StringData @'
    ...
    StorageRedundancy = Storage Redundancy
    CrossRegionRestore = Cross Region Restore
    SoftDeleteState = Soft Delete State
    SoftDeleteRetentionDays = Soft Delete Retention (Days)
...
GetAbrAzNetAppFiles = ConvertFrom-StringData @'
    ...
    AccountsSummary = The following table summarises the NetApp Files accounts within the {0} subscription.
    PoolsSummary = The following table summarises the capacity pools within the {0} subscription.
    VolumesSummary = The following table summarises the volumes within the {0} subscription.
    SnapshotPoliciesSummary = The following table summarises the snapshot policies within the {0} subscription.
    BackupPoliciesSummary = The following table summarises the backup policies within the {0} subscription.
    ...
    UtilizedThroughput = Utilised Throughput (MiB/s)
...
GetAbrAzPrivateDnsZone = ConvertFrom-StringData @'
    ...
    ParagraphSummary = The following table summarises the configuration of the private DNS zone(s) within the {0} subscription.
...
GetAbrAzVirtualNetworkGateway = ConvertFrom-StringData @'
    ...
    ParagraphSummary = The following table summarises the configuration of the virtual network gateway(s) within the {0} subscription.
...
GetAbrAzDdosProtectionPlan = ConvertFrom-StringData @'
    ...
    ParagraphSummary = The following table summarises the configuration of the DDoS Protection Plan(s) within the {0} subscription.
...
GetAbrAzApplicationGateway = ConvertFrom-StringData @'
    ...
    ParagraphSummary = The following table summarises the configuration of the application gateway(s) within the {0} subscription.
...
GetAbrAzDataCollectionRule = ConvertFrom-StringData @'
    ...
    ParagraphSummary = The following table summarises the configuration of the data collection rule(s) within the {0} subscription.
...
GetAbrAzPublicIpAddress = ConvertFrom-StringData @'
    ...
    ParagraphSummary = The following table summarises the configuration of the public IP address(es) within the {0} subscription.
...
GetAbrAzNetworkWatcher = ConvertFrom-StringData @'
    ...
    ParagraphSummary = The following table summarises the configuration of the network watcher(s) within the {0} subscription.
...
GetAbrAzVmScaleSet = ConvertFrom-StringData @'
    ...
    ParagraphSummary = The following table summarises the configuration of the virtual machine scale set(s) within the {0} subscription.
...
GetAbrAzMaintenanceConfiguration = ConvertFrom-StringData @'
    ...
    ParagraphSummary = The following table summarises the configuration of the maintenance configuration(s) within the {0} subscription.
...
GetAbrAzUserAssignedManagedIdentity = ConvertFrom-StringData @'
    ...
    ParagraphSummary = The following table summarises the configuration of the user assigned managed identity/identities within the {0} subscription.
...
GetAbrAzAutomationAccount = ConvertFrom-StringData @'
    ...
    ParagraphSummary = The following table summarises the configuration of the automation account(s) within the {0} subscription.
...
GetAbrAzDiagnosticSetting = ConvertFrom-StringData @'
    ...
    ParagraphSummary = The following table summarises the configuration of the diagnostic setting(s) within the {0} subscription.
...
GetAbrAzDnsForwardingRuleset = ConvertFrom-StringData @'
    ...
    ParagraphSummary = The following table summarises the configuration of the DNS forwarding ruleset(s) within the {0} subscription.
...
GetAbrAzNetworkVirtualAppliance = ConvertFrom-StringData @'
    ...
    ParagraphSummary = The following table summarises the Network Virtual Appliances identified within the {0} subscription.
