# culture = 'fr-FR'
# NOTE: Only the AVD section (GetAbrAzDesktopVirtualization) is translated to French.
...
# Azure Virtual Desktop - FRENCH TRANSLATION
GetAbrAzDesktopVirtualization = ConvertFrom-StringData @'
    InfoLevel = Niveau d'information DesktopVirtualization defini a {0}.
    Collecting = Collecte des informations Azure Virtual Desktop.
    SectionInfo = Azure Virtual Desktop est un service de virtualisation de bureaux et d'applications qui s'execute sur Azure. Il permet aux utilisateurs de se connecter a un bureau complet ou a des applications publiees depuis pratiquement n'importe ou.
    ...
    Status = Etat
    HealthCheck = Verification de l'Etat
    Sessions = Sessions
    ...
    UpdateState = Etat de la Mise a Jour
    AssignedUser = Utilisateur Assigne
    UpdateError = Erreur de Mise a Jour
    VMResourceId = ID de Ressource VM
    HealthChecks = Verifications de l'Etat
    User = Utilisateur
    ...
    PublicNetworkAccess = Acces Reseau Public
    ExclusionTag = Balise d'Exclusion
    HostPoolType = Type de Pool d'Hotes
    HostPoolAssignments = Affectations de Pool d'Hotes
    Days = Jours
    RampUpStart = Debut de Montee en Charge
    ...
    RampUpMinPct = Min de Montee %
    RampUpCapacityPct = Capacite de Montee %
    RampDownAction = Action de Descente
    RampDownMinPct = Min de Descente %
    RampDownCapacityPct = Capacite de Descente %
